...
| **March 30, 2026** | **Full Powered Models**<br>• Create a fully powered LPM model (transformation)<br>• Compare it to a Gradient Boost with cross-validation and grid search |
| **April 1, 2026** | **XGBoost**<br>• Explore and study XGBoost |
